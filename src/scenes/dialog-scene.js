...
export default class DialogScene extends Phaser.Scene {
  ...
  create(data = {}) {
    ...
    this.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.ENTER, true, false)
      .on('down', () => buttonOK.emit('click'));
    this.input.keyboard.addKey(Phaser.Input.Keyboard.KeyCodes.ESC, true, false)
      .on('down', () => buttonCancel.emit('click'));
  }
}
